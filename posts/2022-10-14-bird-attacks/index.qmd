...
Here, a bar chart created with [Observable Plot](https://observablehq.com/@observablehq/plot). If you're used to working in ggplot2, building visualizations following the grammar of graphics in Plot feels similar. Note: Plot also accepts columnar (untransposed) data (thanks Fil!) -- I'll add an example here in a bit.
