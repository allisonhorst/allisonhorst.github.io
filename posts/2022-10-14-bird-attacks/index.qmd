...
Keep in mind that you can't interactively execute JavaScript in RStudio, so building visualizations in [Observable](https://observablehq.com/) is a great option.
